...
OUT = "out_thickness_test/bw2_final"
def b64(p):
...
HTML = f"""<title>High-Contrast Monochrome — Dual-Wall Shadow Reconstruction</title>
<style>
...
<div class="wrap">
  <p class="eyebrow">Dual-Wall Shadow Sculpture · High-Contrast Monochrome</p>
  <h1>Same portrait, contrast cranked up</h1>
  <p class="lede">The Girl front/back pair once more, now as <b>high-contrast</b> black &amp; white — near-black
  garment, blown-out background. The guess was that a more graphic image would suit the medium better.
  It didn't: this is the <b>weakest</b> of the three girl runs.</p>
  ...
  <p class="hint">Notice it's <em>blotchier</em> than the mid-tone version — the extreme tonal range pushes each
  shard toward pure black or pure white, so smooth gray modelling gives way to scattered dark blocks. The
  silhouette reads; the face does not.</p>
  ...
  <div class="finding">
    ...
    <div>
      <p><b>More contrast made it worse, not better.</b> A high-contrast photo isn't a bold <em>flat-shape</em>
      graphic — it's still continuous tone, just squeezed to the extremes. That squeezing collapses the
      mid-tones where cross-wall agreement lived, so double duty fell across all three girl runs:
      colour → mid-tone B&amp;W → high-contrast B&amp;W.</p>
      <div class="cf">
        <span class="pill">colour <b>23.6%</b></span><span class="arrow">→</span>
        <span class="pill">mid-tone B&amp;W <b>18.6%</b></span><span class="arrow">→</span>
        <span class="pill">high-contrast <b>{mean['bgA']:.1f}%</b></span>
      </div>
    </div>
  </div>
...
{rows()}
  ...
  <div class="notes">
    <div class="note"><p class="k">Contrast is not the graphic lever</p>What actually helps the medium is turning
    an image into <b>bold flat shapes</b> (posterising to a few solid tones). Cranking contrast on a photo keeps
    the fine tonal detail and just clips it — so you get harsher blocks, not clearer shapes. Prefer <b>posterise</b>
    over <b>contrast</b> if the goal is graphic legibility.</p>
    <div class="note"><p class="k">Still soft, still black-only</p>As with every girl run, the face doesn't resolve
    (a shard-count limit, unchanged by tone), and grayscale still collapses the build to the <b>K sheet alone</b> —
    a simpler monochrome object that forfeits the coloured-shard idea.</div>
  </div>

  <hr class="rule">
  <p class="h2">How it was made</p>
  <div class="method">
    <div class="mcard"><p class="k">Source pair</p><p class="v"><em>Girl with a Pearl Earring</em><br>front &amp; back, high-contrast grayscale</p></div>
  ...
  <div class="foot"><span>Interactive 3-D scene: <span class="mono">out_thickness_test/bw2_final/scene.html</span></span><span>Multi-seed validated · seed {BEST} shown</span></div>
</div>
<script>
