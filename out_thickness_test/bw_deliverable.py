...
A_IMG = "examples/WhatsApp Image 2026-07-16 at 15.11.53.jpeg"       # 1456 tall = front
B_IMG = "examples/WhatsApp Image 2026-07-16 at 15.11.53 (1).jpeg"   # 1503 tall = back
MT = 0.30; OUT = "out_thickness_test/bw_final"; os.makedirs(OUT, exist_ok=True)
...
SEEDS = [1, 2, 3, 4, 5]
print(f"pair: Girl front/back BLACK & WHITE  |  signed dw0.5 cw0.5 match_tol {MT}\n")
...
plt.suptitle(f"Girl B&W front/back — seed {r['seed']} ({r['shards']} shards, {r['used']}/14 panels)", fontsize=14, y=0.997)
